...
test_cases = [
    ("/api/us/quote", "ust10000", {"symb": config.TICKER_LONG, "excd": "NAS"}),
    ...
    ("/api/us/order", "tt80010", {"cano": broker.account_no, "acnt_prdt_cd": "01", "symb": config.TICKER_LONG, "excd": "NAS", "ord_qty": "1", "ord_unpr": "0", "ord_dv": "01"}),
    ("/api/us/order", "ust80010", {"cano": broker.account_no, "acnt_prdt_cd": "01", "symb": config.TICKER_LONG, "excd": "NAS", "ord_qty": "1", "ord_unpr": "0", "ord_dv": "01"}),
]
