...
def run_cold_start_v10():
    ...
    sample_experts = [
        ("cross_asset", 0.78, 0.65, {"elapsed_min": 45, "vix_level": 16.2, "atr_ratio": 1.15, "cvd_delta": 1.40, "dislocation_lag": 1.25}, "LONG_SOXL", 28.50, 29.50, "+3.50% TP", 650000),
        ("orderflow", 0.82, 0.68, {"elapsed_min": 15, "vix_level": 17.1, "atr_ratio": 1.42, "cvd_delta": 1.85, "dislocation_lag": 0.40}, "LONG_SOXL", 27.80, 28.77, "+3.50% TP", 665000),
        ("statespace_kalman", 0.75, 0.62, {"elapsed_min": 180, "vix_level": 20.5, "atr_ratio": 0.95, "cvd_delta": -0.80, "dislocation_lag": -0.90}, "SHORT_SOXS", 22.40, 23.18, "+3.50% TP", 640000),
        ("tda_topology", 0.70, 0.61, {"elapsed_min": 60, "vix_level": 18.0, "atr_ratio": 1.28, "cvd_delta": 0.95, "dislocation_lag": 0.35}, "LONG_SOXL", 29.10, 28.52, "-2.00% SL", -380000),
        ("cross_asset", 0.85, 0.72, {"elapsed_min": 110, "vix_level": 15.8, "atr_ratio": 1.08, "cvd_delta": 1.55, "dislocation_lag": 1.48}, "LONG_SOXL", 30.20, 31.26, "+3.50% TP", 680000)
    ]
    ...
    test_qty = broker.calculate_safe_order_qty("SOXL", 30.0, 100000.0, fee_buffer_pct=0.0035)
    print(f"   ✅ $100,000 USD 전액 운용 시 SOXL 안전 주문 주수: {test_qty}주 (math.floor 정수 절사)")
...
• **알림 예시:** `[Track 6 MoE 체결] 방향: SOXL | 채택 Expert: 크로스에셋 괴리 (적합도: 78%, 확신도: 65%)`
