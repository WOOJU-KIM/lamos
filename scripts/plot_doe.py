...
files = [
    'data/backtest_5m_precision_rolling_wfa_tp0.009_sl0.006.json',
    'data/backtest_5m_precision_rolling_wfa_tp0.012_sl0.008.json',
...
plt.title('DoE: KOSPI Lamos WFA 1.5:1 Risk/Reward Scenarios')
plt.xlabel('Date')
plt.ylabel('Account Balance (KRW)')
plt.grid(True, linestyle='--', alpha=0.6)
plt.legend()
plt.tight_layout()
plt.savefig('data/doe_wfa_equity_curves.png')
