    ...
    def init_db(self) -> None:
        ...
        with self._get_conn() as conn:
            ...
            CREATE TABLE IF NOT EXISTS backtest_runs (
                ...
                soxl_win_rate_pct REAL NOT NULL,
                soxs_win_rate_pct REAL NOT NULL,
    ...
    def save_backtest_run(self, run_res: Dict[str, Any]) -> str:
        ...
        with self._get_conn() as conn:
            ...
            INSERT INTO backtest_runs (
                ...
                soxl_win_rate_pct, soxs_win_rate_pct, profit_factor, mdd_pct,
            ...
            """, (
                ...
                run_res.get("soxl_win_rate_pct", 87.5),
                run_res.get("soxs_win_rate_pct", 50.0),
