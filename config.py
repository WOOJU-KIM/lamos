...
SL_MIN_PCT = 0.012                 # 최소 손절 라인 (1.2% KOSPI 특화)

SL_MAX_PCT = 0.012                # 최대 손절 라인 (1.2% KOSPI 특화)

MAX_TP_PCT = 0.10                 # 목표 익절 라인 (10.0%)

TRAILING_TRIGGER_PCT = 0.010      # 트레일링 스탑 발동 조건 (+1.0%)
...
# I0 ۊ?? ?|1 (Tickers & Features)

# ==============================================================================

TICKER_LONG = "122630"       # o??J???(rn׬0 TQQQ)

TICKER_SHORT = "252670"      # ???J???(rn׬0 SQQQ)
